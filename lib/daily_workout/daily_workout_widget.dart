...
export 'daily_workout_model.dart';
import 'package:iron_body/backend/app_state.dart';



class DailyWorkoutWidget extends StatefulWidget {
  const DailyWorkoutWidget({Key? key}) : super(key: key);

  @override
  _DailyWorkoutWidgetState createState() => _DailyWorkoutWidgetState();
}

class _DailyWorkoutWidgetState extends State<DailyWorkoutWidget> {
  late DailyWorkoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DailyWorkoutModel());
  }
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0x1A3C3C38), Color(0xD81C1C1E)],
                            stops: [0.0, 1.0],
