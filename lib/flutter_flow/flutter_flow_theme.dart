...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF3EC46);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF8C8B8C);
  late Color primaryBackground = const Color(0xFF1C1C1E);
  late Color secondaryBackground = const Color(0xFF3C3C38);
  ...
  late Color menu = Color(0xFFFFFFFF);
