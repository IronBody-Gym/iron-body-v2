...
import 'create_workout_final_model.dart';
export 'create_workout_final_model.dart';
import 'package:iron_body/backend/app_state.dart';



class CreateWorkoutFinalWidget extends StatefulWidget {
  const CreateWorkoutFinalWidget({Key? key}) : super(key: key);

  @override
  _CreateWorkoutFinalWidgetState createState() =>
      _CreateWorkoutFinalWidgetState();
}

class _CreateWorkoutFinalWidgetState extends State<CreateWorkoutFinalWidget> {
  late CreateWorkoutFinalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateWorkoutFinalModel());
    ...
    _model.textController38 ??= TextEditingController();
    _model.textController39 ??= TextEditingController();
    _model.textController40 ??= TextEditingController();
    _model.textController41 ??= TextEditingController();
    ...
    _model.textController45 ??= TextEditingController();
    _model.textController46 ??= TextEditingController();
    _model.textController47 ??= TextEditingController();
    _model.textController48 ??= TextEditingController();
    _model.textController49 ??= TextEditingController();
    _model.textController50 ??= TextEditingController();
  }
