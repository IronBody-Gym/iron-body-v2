...
class _Login2WidgetState extends State<Login2Widget> {
  ...
  void initState() {
    ...
    _model.passwController ??= TextEditingController();
  }
            ...
            children: [
              Container(
                ...
                child: Stack(
                  children: [
                    CachedNetworkImage(
                      imageUrl: 'https://i.imgur.com/Y8W9hlR.jpeg',
                      width: double.infinity,
                      height: 500.0,
                      fit: BoxFit.cover,
                    ),
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      20.0, 25.0, 20.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.passwController,
                                    autofocus: true,
                                    obscureText: !_model.passwVisibility,
                                    decoration: InputDecoration(
                                      hintText: 'Contraseña',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                    ...
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    validator: _model.passwControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Align(
